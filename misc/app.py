...
# ask_api: Calls locally hosted api using lcserve
# lcserve_host: The host where the lcserve is running
...
title = "PDF GPT"
description = """ PDFFFFFF GPT allows you to chat with your PDF file using Universal Sentence Encoder and Open AI. It gives hallucination free response than other tools as the embeddings are better than OpenAI. The returned response can even cite the page number in square brackets([]) where the information is located, adding credibility to the responses and helping to locate pertinent information quickly."""
...
demo.launch(
    server_port=7860, enable_queue=True
